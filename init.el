...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (undo-tree tabbar-ruler smartparens smart-mode-line-powerline-theme racket-mode neotree multiple-cursors hindent helm expand-region company-ghci company-ghc))))
(custom-set-faces
